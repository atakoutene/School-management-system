 ...
 * @author Steve Meudje
 */
public class StoreFaculty {
     public static void storefaculty (CRUDFaculty l){
        FileOutputStream fos = null;
        try {
            fos = new FileOutputStream("src/Resource/faculty.txt");
            try (PrintWriter dos = new PrintWriter(fos)) {
                ...
                for (int i = 0; i < l.getList().size(); i++) {
                    ...
                    dos.print(l.getList().get(i).getRank()+" ");
